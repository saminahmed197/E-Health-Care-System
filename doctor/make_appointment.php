...
<div class="form-style-5">
  <form action=<?php echo '"update_appointment.php?chamber_id='.$chamber_id.'&Doctorid='.$Doctorid.'"' ?>  method= "POST">
    <fieldset>
...
<?php 
  if ($_SERVER["REQUEST_METHOD"] == "POST"){
    ...
    if (isset($_GET['a_id'])) {
      ...
      echo $chamber_id.'<br>';
      echo $Doctorid.'<br>';
      $sql =  "UPDATE appointment SET date_=$date, Patient_id=$patient_id, Doctorid=$Doctorid, Chamber_id=$chamber_id WHERE Appointment_id='$a_id'";
